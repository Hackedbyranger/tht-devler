print("Bu şifre oluşturucuyu yaparken bir arkadaşımdan yardım aldım .Çok eksiğimin olduğunun farkındaydım . En kısa sürede tamamlayacağım //Ranger")
import random 
import time 
...
while (True): 
  try:
    ...
    time.sleep(3) #Ranger süs için konulmuştur .
